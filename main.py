    ...
    for event in pygame.event.get() : 
        ...
        if event.type == pygame.MOUSEBUTTONUP:
            ...
            if choixUser == "X" or choixUser == "O":
                rec_1 = pygame.draw.rect(display_surface, blanc, (0,0,0,0))
                rec_2 = pygame.draw.rect(display_surface, blanc, (0,0,0,0))
                fin = True
            else:
                fin = False
...
if fin == True:
    # Coder ici | Quand tout va bien
    pass
if(fin == True and choixUser == "X [default]"):
